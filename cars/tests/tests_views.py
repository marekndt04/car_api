...
class TestRateCarView(TestCase):
    ...
    def test_view_returns_error_with_bad_request_structure(self):
        response = self.client.post(self.url, {"again": "something", "went": "wrong"})
    ...
    def test_view_saves_rate_properly(self):
        ...
        self.client.post(self.url, {"make": car.make, "model": car.model, "rate": 5})
    ...
    def test_view_saves_votes_properly(self):
        ...
        self.client.post(self.url, {"make": car.make, "model": car.model, "rate": 4})
